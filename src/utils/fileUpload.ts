import { PINATA_API_KEY, PINATA_SECRET_API_KEY } from "@/config/TextData";
import { metadataInfo } from "./types";


const pinataApiKey: string | undefined = PINATA_API_KEY;
const pinataSecretApiKey: string | undefined = PINATA_SECRET_API_KEY;
