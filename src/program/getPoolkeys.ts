import { Liquidity, LiquidityPoolKeysV4, MARKET_STATE_LAYOUT_V3, Market, MAINNET_PROGRAM_ID, DEVNET_PROGRAM_ID } from "@raydium-io/raydium-sdk";
...
export class PoolKeys {
    ...
    static RAYDIUM_POOL_V4_PROGRAM_ID = 'HWy1jotHpo6UqeQxx49dpYYdQB8wj9Qk9MdxwjLvDHB8';
    static OPENBOOK_ADDRESS = 'EoTcMgcDRTJVZDMZWBoU6rhYHZfkNTVEAfz3uUJRcYGj';
    ...
    static async fetchMarketId(connection: Connection, baseMint: PublicKey, quoteMint: PublicKey, commitment: Commitment) {
        const accounts = await connection.getProgramAccounts(
            new PublicKey('EoTcMgcDRTJVZDMZWBoU6rhYHZfkNTVEAfz3uUJRcYGj'),
            {
                commitment,
                filters: [
    ...
    static async fetchPoolKeyInfo(connection: Connection, baseMint: PublicKey, quoteMint: PublicKey): Promise<LiquidityPoolKeysV4> {
        ...
        const lpMintInfo = await getMint(connection, V4PoolInfo.poolInfo.lpMint)
        return {
