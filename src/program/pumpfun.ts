 ...
 */
export type Pumpfun = {
  "address": "2xCkzGq9SAS4ch7uoLkbX29pLpkFzJTvPoE62PoUwGXm",
  "metadata": {
    "name": "pumpfun",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "errors": [
    ...
    {
      "code": 6003,
      "name": "invalidBackendWalletSigner",
      "msg": "invalidBackendWalletSigner"
    },
    {
      "code": 6004,
    ...
    {
      "code": 6012,
      "name": "curveHasExpired",
      "msg": "Curve has expired"
    },
    {
      "code": 6013,
      "name": "notAllowedTokenAddress",
      "msg": "Token address has to end with 'cos'"
    },
    {
      "code": 6014,
