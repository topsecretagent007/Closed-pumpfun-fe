...
const Countdown: React.FC<CountdownProps> = ({ time }) => {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center bg-black/20 mx-auto px-2 2xs:px-4 md:px-2 md2:px-4 pt-2 2xs:pt-4 md:pt-2 md2:pt-4 pb-1 2xs:pb-2 md:pb-1 md2:pb-2 border border-white/10 rounded-3xl w-full max-w-lg h-full object-cover overflow-hidden">
      <Image
        src={TimeBg}
